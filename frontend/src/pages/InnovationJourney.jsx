...
import { Trophy, Award, ShieldCheck, Zap, RefreshCw, Loader2 } from 'lucide-react';
...
const InnovationJourney = ({ activeProject }) => {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-amber-900/60 via-slate-800 to-slate-900 border border-amber-500/30 rounded-3xl p-6 shadow-xl">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <h1 className="text-2xl sm:text-3xl font-extrabold text-white">Innovation Journey Roadmap</h1>
          ...
          <button
            ...
            className="flex items-center space-x-2 px-4 py-2 bg-slate-800 border border-slate-700 hover:bg-slate-700 text-slate-300 rounded-xl text-xs font-bold transition-colors shrink-0 self-start md:self-auto"
          >
      ...
      {loading ? (
        ...
        <div className="bg-slate-800/40 border border-dashed border-slate-700 rounded-3xl p-12 text-center text-slate-400">
          ...
          <h3 className="text-base font-bold text-slate-300">No Active Journey Found</h3>
        ...
        <div className="space-y-8 animate-fadeIn">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            {/* Stat 1: Total XP */}
            <div className="bg-slate-800/90 border border-amber-500/30 rounded-2xl p-4 text-center">
              <span className="text-[10px] font-extrabold uppercase text-amber-400 tracking-wider">Total XP</span>
              <div className="text-2xl font-black text-white mt-1 flex items-center justify-center space-x-1">
            ...
            <div className="bg-slate-800/90 border border-indigo-500/30 rounded-2xl p-4 text-center">
              <span className="text-[10px] font-extrabold uppercase text-indigo-400 tracking-wider">Current Level</span>
              <div className="text-2xl font-black text-white mt-1 flex items-center justify-center space-x-1">
            ...
            <div className="bg-slate-800/90 border border-purple-500/30 rounded-2xl p-4 text-center">
              <span className="text-[10px] font-extrabold uppercase text-purple-400 tracking-wider">Current Stage</span>
              <div className="text-base font-black text-purple-200 mt-1 truncate">
                {journeyData.current_stage}
              </div>
            </div>

            {/* Stat 4: Completion % */}
            <div className="bg-slate-800/90 border border-emerald-500/30 rounded-2xl p-4 text-center">
              <span className="text-[10px] font-extrabold uppercase text-emerald-400 tracking-wider">Completion</span>
              <div className="text-2xl font-black text-emerald-300 mt-1">
                {journeyData.completion_percentage}%
              </div>
            </div>
          ...
          <div className="bg-slate-800/90 border border-slate-700 rounded-3xl p-6 shadow-xl space-y-3">
            ...
            <ProgressBar label="Progress to Next Level" value={levelProgressPercentage} color="amber" showPercentage={false} />
          </div>
