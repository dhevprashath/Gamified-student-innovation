...
- Name: login.spec.js >> Student Login Flow >> should test logout if application supports it
...
Locator: getByRole('button', { name: /logout|sign out/i })
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('button', { name: /logout|sign out/i }) with timeout 5000ms
  - waiting for getByRole('button', { name: /logout|sign out/i })
